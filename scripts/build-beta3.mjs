...
export const cachedAssets=['index.html','app/app.js','app/core.js','app/operations.js','app/tracking-adapter.js','app/styles.css','app/print.css','command/index.html','guided/index.html','rider/index.html','tracking/index.html','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-192.png','icons/icon-maskable-512.png'];
...
export async function buildBeta3(output=out){
 await rm(output,{recursive:true,force:true});await mkdir(`${output}/app`,{recursive:true});await mkdir(`${output}/icons`,{recursive:true});
