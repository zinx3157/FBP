...
public class MainActivity extends AppCompatActivity {
    private static final String APP_URL =
            "https://zinx3157.github.io/FBP/labelonzeway-v7/?v=release-2.5.1-20260913&app=android-2.5.1";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " LabelOnZeWayAndroid/2.5.1");
